...
// "parse_usage".
typedef void (*report_parse_input_report_fn_t)(struct uni_hid_device_s* d, 
...
typedef void (*report_set_rumble_fn_t)(struct uni_hid_device_s* d, 
                                        uint8_t force, 
                                        uint8_t duration);
typedef void (*report_set_rumble_2_fn_t)(struct uni_hid_device_s* d, 
                                            uint8_t l_force, 
                                            uint8_t r_force, 
                                            uint8_t duration);
...
typedef struct {
    ...
    // If implemented, activates rumble in the gamepad
    report_set_rumble_2_fn_t set_rumble_2;
} uni_report_parser_t;
